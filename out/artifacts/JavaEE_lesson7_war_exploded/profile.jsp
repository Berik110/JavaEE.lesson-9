    ...
    <div class="row">
        <div class="col-sm-6 offset-3">
            ...
            <form action="updatepicture" method="post">
                <div class="row mt-2">
                    <div class="col-sm-12">
                        <input type="text" name="url" class="form-control" placeholder="Put URL of your picture">
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-sm-12">
                ...
                <div class="row mt-5">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="full_name" class="form-control" value="<%=currentUser.getFullName()%>">
                        </div>
                    </div>
                </div>
                <div class="row mt-2">
